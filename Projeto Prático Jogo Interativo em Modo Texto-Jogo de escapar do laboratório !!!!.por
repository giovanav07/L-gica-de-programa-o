programa
{
	...
	u.aguarde(3000)
	escreva("A cena diante de você era a de um ex-humano.\n\n")
	u.aguarde(3000)
	...
	escreva("Você conseguiu matar o ex-humano!\n")		
	u.aguarde(1000)
	escreva("Ao olhar para esse ex-humano morto, você se lembra de que ele era um sujeito de experimentos e que estava sorridente antes do experimento.\n")
	u.aguarde(5000)
	escreva("E você lembrou que foi seu erro durante o experimento, que causou caos em todo o laboratório.\n")
	u.aguarde(2000)
	...
	se (NOx=="Redução de 4 unidades")
	{
	escreva("Ao abrir aquela porta, um ser aparentemente ex-humano se apresenta diante de você, e atrás dele está o portão da liberdade.\n")
	u.aguarde(3000)
	...
	u.aguarde(6000)	     
	escreva("Você saiu da cena e está lentamente a caminho da delegacia, pois terá que confessar seus erros e pagar o preço. Mas pelo menos você é honesto, certo...?")
	u.aguarde(4000)
	ganhou=verdadeiro
	}
	}
